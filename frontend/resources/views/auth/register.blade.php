...
<html lang="en">
    ...
    <head>
        ...
        <style type="text/css">
            ...
            .account-block {
                padding: 0;
                background-image: url('https://i.pinimg.com/564x/99/93/2b/99932bb691426c5c7ca01fb6529c797f.jpg');
        ...
        <div id="main-wrapper" class="container">
            <div class="row justify-content-center align-items-center mb-5">
                <div class="col-xl-10">
                            ...
                            <div class="row no-gutters">
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        ...
                                        <p class="text-muted mt-2 mb-5">register yourself</p>
                                        <form method="POST" action="/register41">
                                            @csrf
                                            @error('email')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="name" required autocomplete="name" value="{{old('name')}}">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group mb-5">
                                                ...
                                                <input type="file"
                                                    ...
                                                    id="foto" name="foto" required autocomplete="foto">
                                            </div>
                    ...
                    <!-- end card -->
                    <p class="text-muted text-center mt-3 mb-0">Don't have an account? <a href="/login41"
